...
def run_test_go_straight_for_seconds():
    ...
    note.go_straight_for_seconds(4, 20)
...
def run_test_go_straight_for_inches():
    ...
    note.go_straight_for_inches(10, 50)
...
def run_test_go_straight_until_black():
    ...
    note.go_straight_until_black(20)
...
class SimpleRoseBot(object):
    ...
    def go_straight_for_inches(self, inches, speed):
        ...
        needed_degrees = (inches / (math.pi * 1.3)) * 360

        while True:
            if self.left_motor.get_position() >= (starting_position + needed_degrees):
                break
